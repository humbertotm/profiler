(ns profiler.calculations.descriptors)

(def descriptor-spec
  "Defines the spec employed to calculate each of the required descriptors."
  {:current-assets {:computation-fn :simple-number,
                    :args {:tag "AssetsCurrent"}},
   :current-liabilities {:computation-fn :simple-number,
                         :args {:tag "LiabilitiesCurrent"}},
   :accounts-payable {:computation-fn :simple-number,
                      :args {:tag "AccountsPayableCurrent"}},
   :total-liabilities {:computation-fn :simple-number,
                       :args {:tag "Liabilities"}},
   :total-assets {:computation-fn :simple-number,
                  :args {:tag "Assets"}},
   :goodwill {:computation-fn :simple-number,
              :args {:tag "Goodwill"}},
   :depreciation {:computation-fn :simple-number,
                  :args {:tag "DepreciationDepletionAndAmortization"}},
   :capital-expenditures {:computation-fn :simple-number,
                          :args {:tag "CapitalExpenditures"}},
   ...
   :stock-options-exercised {:computation-fn :simple-number,
                             :args {:tag "StockIssuedDuringPeriodSharesStockOptionsExercised"}},
   :stock-options-granted {:computation-fn :simple-number,
                           :args {:tag "ShareBasedCompensationArrangementByShareBasedPaymentAwardOptionsGrantsInPeriod"}},
   :stock-repurchase-payment {:computation-fn :simple-number,
   ...
   :inventory {:computation-fn :simple-number,
               :args {:tag "InventoryNet"}},
   :dividend-payment {:computation-fn :simple-number,
                      :args {:tag "PaymentsOfDividends"}},
   :dividends-per-share-paid {:computation-fn :simple-number,
                              :args {:tag "CommonStockDividendsPerShareCashPaid"}},
   :operating-income {:computation-fn :simple-number,
